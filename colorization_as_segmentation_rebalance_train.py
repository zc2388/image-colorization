...
def train(batch_size, epochs, lr_base, lr_power, weight_decay, classes,
    ...
    optimizer = LR_SGD(lr=lr_base, momentum=0.9, decay=0.0, nesterov=False,multipliers = LR_mult_dict)
...
if __name__ == '__main__':
    ...
    if dataset == 'flower':
        ...
        data_dir        = os.path.expanduser('~/dataset/flowers/jpg') #('~/.keras/datasets/VOC2012/VOCdevkit/VOC2012/JPEGImages')
        label_dir       = os.path.expanduser('~/dataset/flowers/color_label') #('~/.keras/datasets/VOC2012/color_segmentation_classes')
        data_suffix='.jpg'
        label_suffix='.npy'
        classes = 314
