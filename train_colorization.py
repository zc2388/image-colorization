...
def train(batch_size, epochs, lr_base, lr_power, weight_decay, classes,
    ...
    # ###################### optimizer ########################
    LR_mult_dict = {}
    LR_mult_dict['colorization_conv1']=10
    LR_mult_dict['colorization_conv2']=10
    ...
    model.compile(loss=L2_ab_regression_loss,
                  optimizer=optimizer,
    ...
    train_datagen = ColorizationDataGenerator(zoom_range=[1.0, 2.0],
